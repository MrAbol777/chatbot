...
export function createVideoGenerationError(value?: string, status?: number): VideoGenerationError {
  ...
  return Object.assign(new Error(messages[code] || 'مشکلی در آماده‌سازی استودیو پیش آمد. دوباره تلاش کنید؛ اگر ادامه داشت، کمی بعد برگردید.'), { code, status });
}
