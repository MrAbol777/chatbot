...
const isCapability = (value: unknown) => isRecord(value) && Array.isArray(value.allowedAspectRatios) && Array.isArray(value.allowedDurations) && Array.isArray(value.allowedQualities) && Array.isArray(value.allowedResolutions) && (typeof value.maxPromptLength === 'number' || value.maxPromptLength === null) && (value.providerPromptMaxLength === undefined || typeof value.providerPromptMaxLength === 'number' || value.providerPromptMaxLength === null);
