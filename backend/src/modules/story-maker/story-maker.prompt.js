...
function buildScenarioPrompt(draft, contextInput) {
  ...
  return [
    ...
    'پاسخ را فشرده و آماده‌ی تولید نگه دار: هر فیلد حداکثر یک جمله‌ی کوتاه باشد؛ دیالوگ هر صحنه حداکثر ۱۲ کلمه و پرامپت تصویر حداکثر ۲۵ کلمه باشد. از تکرار توضیحات بین فیلدها پرهیز کن.',
