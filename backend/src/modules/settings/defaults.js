...
const SETTING_DEFINITIONS = {
  ...
  'conversation_title.enabled': { label: 'فعال بودن عنوان خودکار گفتگو', type: 'boolean', category: 'ai', defaultValue: true, adminEditable: true },
  'conversation_title.model': { label: 'مدل عنوان خودکار گفتگو', type: 'string', category: 'ai', defaultValue: 'gemini-2.5-flash-lite', adminEditable: true },
  'conversation_title.temperature': { label: 'Temperature عنوان گفتگو', type: 'number', category: 'ai', defaultValue: 0, min: 0, max: 0.2, adminEditable: true },
  'conversation_title.timeout_ms': { label: 'Timeout عنوان گفتگو (ms)', type: 'number', category: 'ai', defaultValue: 6000, min: 500, max: 30000, adminEditable: true },
  'conversation_title.max_retries': { label: 'تعداد retry عنوان گفتگو', type: 'number', category: 'ai', defaultValue: 1, min: 0, max: 1, adminEditable: true },
  'conversation_title.max_output_tokens': { label: 'Max tokens عنوان گفتگو', type: 'number', category: 'ai', defaultValue: 64, min: 16, max: 256, adminEditable: true },
  'conversation_title.max_characters': { label: 'حداکثر کاراکتر عنوان گفتگو', type: 'number', category: 'ai', defaultValue: 40, min: 12, max: 80, adminEditable: true },
  'conversation_title.version': { label: 'نسخه عنوان خودکار گفتگو', type: 'string', category: 'ai', defaultValue: '1', adminEditable: true },
