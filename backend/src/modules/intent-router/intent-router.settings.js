...
const normalizeIntentRouterSettings = ({ settings = {}, routerConfig = {} } = {}) => ({
  ...
  allowChatKeyFallback: normalizeBoolean(get(settings, intentRouterSettingKey.allowChatKeyFallback, routerConfig.allowChatKeyFallback ?? true), true),
