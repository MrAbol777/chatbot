...
const JOB_TRANSITIONS = Object.freeze({
  [JOB_STATUSES.QUEUED]: new Set([JOB_STATUSES.ROUTING, JOB_STATUSES.SUBMITTING, JOB_STATUSES.SUBMITTED, JOB_STATUSES.FAILED, JOB_STATUSES.CANCELLED, JOB_STATUSES.EXPIRED]),
  [JOB_STATUSES.ROUTING]: new Set([JOB_STATUSES.SUBMITTING, JOB_STATUSES.FAILED, JOB_STATUSES.CANCELLED, JOB_STATUSES.EXPIRED]),
  [JOB_STATUSES.SUBMITTING]: new Set([JOB_STATUSES.QUEUED, JOB_STATUSES.SUBMITTED, JOB_STATUSES.PROVIDER_STATUS_UNKNOWN, JOB_STATUSES.FAILED, JOB_STATUSES.CANCELLED, JOB_STATUSES.EXPIRED]),
  ...
  [JOB_STATUSES.PROVIDER_STATUS_UNKNOWN]: new Set([JOB_STATUSES.SUBMITTED, JOB_STATUSES.FAILED, JOB_STATUSES.CANCELLED, JOB_STATUSES.EXPIRED]),
