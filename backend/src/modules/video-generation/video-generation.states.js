...
const JOB_TRANSITIONS = Object.freeze({
  ...
  [JOB_STATUSES.SUBMITTING]: new Set([JOB_STATUSES.SUBMITTED, JOB_STATUSES.PROVIDER_STATUS_UNKNOWN, JOB_STATUSES.FAILED, JOB_STATUSES.CANCELLED, JOB_STATUSES.EXPIRED]),
