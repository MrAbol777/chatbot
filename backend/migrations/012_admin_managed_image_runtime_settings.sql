...
VALUES
  ...
  ('ai.image.model_preset', JSON_QUOTE('nano-banana-pro'), 'ai', NOW()),
  ('ai.image.model.admin_value', JSON_QUOTE('gemini-3-pro-image'), 'ai', NOW()),
  ('ai.image.model.runtime_provider_name', JSON_QUOTE('google'), 'ai', NOW()),
  ('ai.image.model.runtime_model', JSON_QUOTE('nano-banana-pro'), 'ai', NOW()),
