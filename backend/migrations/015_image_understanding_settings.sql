...
VALUES
  ('ai.vision.enabled', CAST('true' AS JSON), 'ai', NOW()),
  ...
  ('ai.vision.max_image_mb', CAST('10' AS JSON), 'ai', NOW()),
  ...
  ('ai.vision.allow_chat_key_fallback', CAST('false' AS JSON), 'ai', NOW()),
  ('ai.vision.store_metadata', CAST('true' AS JSON), 'ai', NOW()),
