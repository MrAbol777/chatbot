...
CREATE TABLE IF NOT EXISTS character_workspaces (
  ...
  CONSTRAINT fk_character_workspaces_user FOREIGN KEY (user_id) REFERENCES app_users(user_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS storyboard_workspaces (
  ...
  CONSTRAINT fk_storyboard_workspaces_user FOREIGN KEY (user_id) REFERENCES app_users(user_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
